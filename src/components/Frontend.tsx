...
const INITIAL_RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'HQ-002 Resources',
    drive_link: 'https://drive.google.com/drive/folders/1W43QF0XwNez1XMYYF-j0rBJyZjxoB9v1',
    description: 'Academic resources and study material for HQ-002.',
  ...
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Programming Fundamentals (Folder 1)',
    drive_link: 'https://drive.google.com/drive/folders/1qr9N8lXWjs9L4w08N3gy2nvwtMRC2UVI?usp=drive_link',
    description: 'Programming Fundamentals study material and resources.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Programming Fundamentals (Folder 2)',
    drive_link: 'https://drive.google.com/drive/folders/1b0_bSh1TVK1s87TeFs8SdMEXObC-Csc0',
    description: 'Additional resources for Programming Fundamentals.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Expository Writing (Folder 1)',
    drive_link: 'https://drive.google.com/drive/folders/1qzIYUhWVXfhAlRovJ14kDP_qgQdtiogM?usp=drive_link',
    description: 'Expository Writing study material and resources.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Expository Writing (Folder 2)',
    drive_link: 'https://drive.google.com/drive/folders/1xpuVvSKMO-KiHHqMVZZ3rO_DvGtgjHmk',
    description: 'Additional resources for Expository Writing.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Computer Networks (Folder 1)',
    drive_link: 'https://drive.google.com/drive/folders/16LWHBNMO_Ok9oXX16iErzQ2aUeHyiBA7',
    description: 'Computer Networks study material and resources.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Computer Networks (Folder 2)',
    drive_link: 'https://drive.google.com/drive/folders/19qJWxRBHy7-Y7XCqnQYRkWQmwQjl_5uA?usp=drive_link',
    description: 'Additional resources for Computer Networks.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Computer Networks (Folder 3)',
    drive_link: 'https://drive.google.com/drive/folders/1a2hxAUWYJBZymHqIrMnlfGLMtcbeHAyh',
    description: 'More resources for Computer Networks.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Discrete Structure (Folder 1)',
    drive_link: 'https://drive.google.com/drive/folders/1LDwVZWRbOkc9VeziLfnJI4a8Yeg8POMT',
    description: 'Discrete Structure study material and resources.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Discrete Structure (Folder 2)',
    drive_link: 'https://drive.google.com/drive/folders/1Of55wSBKmJAb-qnlq-_iPHAocWIq0wgQ?usp=drive_link',
    description: 'Additional resources for Discrete Structure.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Introduction to Marketing (Folder 1)',
    drive_link: 'https://drive.google.com/drive/folders/10Q6dJBuSKOQy-ORvz-mNkmtlGF0dnzbN',
    description: 'Introduction to Marketing study material and resources.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Introduction to Marketing (Folder 2)',
    drive_link: 'https://drive.google.com/drive/folders/1dMpq1-lEy3a8E1eP4lwc7FG20B9NjjB-',
    description: 'Additional resources for Introduction to Marketing.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Math Deficiency-002 (Folder 1)',
    drive_link: 'https://drive.google.com/drive/folders/1Y8Sv8RI1EdSIOsEEz_HbxH9_WU5Kj8jz',
    description: 'Math Deficiency-002 study material and resources.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Math Deficiency-002 (Folder 2)',
    drive_link: 'https://drive.google.com/drive/folders/1wIVbgojq5Vjg6yypfpnTASmYgU6ldIV0',
    description: 'Additional resources for Math Deficiency-002.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    subject_id: 0,
    category_id: 0,
    title: 'Math Deficiency-002 (Folder 3)',
    drive_link: 'https://drive.google.com/drive/folders/1hrDoWXOI1OVRXy5PtYEEu4ThTKNhALiW?usp=drive_link',
    description: 'More resources for Math Deficiency-002.',
    status: 'active' as const,
    category_name: 'Notes',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
